  ...
  return (
    <div className="min-h-screen bg-surface flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 overflow-auto px-4 py-6 sm:px-6 sm:py-8 lg:px-8 lg:py-8">
  ...
  return (
    <div className="flex items-center justify-between h-16 px-4 border-b border-border-muted shrink-0">
      ...
      <button
        type="button"
        onClick={onClose}
        className="p-2 rounded-lg text-gray-500 hover:bg-gray-100 lg:hidden shrink-0"
...
export function SidebarNavSection({
  ...
  return (
    <div className="space-y-0.5">
      <button
        type="button"
        className={`${sidebarSectionLabelClass} w-full flex items-center justify-between gap-2 rounded-md hover:text-gray-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-1`}
        aria-expanded={open}
